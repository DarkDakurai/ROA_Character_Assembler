...
repeat array_length(tabs){
	...
	if tab == tabb{
		...
		draw_rectangle_colour(px + 200*_i + 5, 10, px + 200*_i + 190, 62, c_white, c_white, c_white, c_white, 0);
		draw_text_colour(px + 200*_i + 15, 30, string_copy(tabb.name, 1, min(14, string_length(tabb.name)-4)), 0, 0, 0, 0, 1)
		...
		draw_rectangle_colour(px + 200*_i + 5, 10, px + 200*_i + 190, 62, c_white, c_white, c_white, c_white, 1);
		draw_text(px + 200*_i + 15, 30, string_copy(tabb.name, 1, min(14, string_length(tabb.name)-4)))
		if hovered_x == _i draw_text_colour(px + 200*_i + 167, 28, chr(1000), c, c, c, c, 1);
		draw_text_colour(px + 200*_i + 170, 30, "X", c, c, c, c, 1);
	}
	_i++;
